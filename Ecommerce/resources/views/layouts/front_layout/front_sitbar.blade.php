<?php
 ...
 ?>
			...
			<div id="sidebar" class="span3">
				<div class="well well-small"><a id="myCart" href="product_summary.html"><img src="{{asset('images/front_img/ico-cart.png')}}" alt="cart">3 Items in your cart</a></div>
				...
				<br/>
				<div class="thumbnail">
					<img src="{{asset('images/front_img/payment_methods.png')}}" title="Payment Methods" alt="Payments Methods">
					<div class="caption">
