						...
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
										...
										@endif
									<form class="row g-3 needs-validation" @if(empty($branddata['id'])) action="{{url('admin/add-edit-brand')}}" @else   action="{{url('admin/add-edit-brand/'.$branddata['id'] )}}" @endif method="post">
                                    @csrf
